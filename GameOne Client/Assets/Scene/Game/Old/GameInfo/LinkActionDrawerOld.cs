...
{
    public class LinkActionDrawerOld : MonoBehaviour
    {
        ...
        public void Start()
        {
            ...
            LinkSprite = Resources.Load("Game/Textures/Arrow", typeof(Sprite)) as Sprite;
        ...
        public void UpdateInfo(DragInfoOld drag, LinkState state)
        {
            SetSpite(state);
